...
public class ModEventBusEvents {
    ...
    public static void entityAttributeEvent(EntityAttributeCreationEvent event) {
        event.put(ModEntityTypes.DASPLETOSAURUS.get(), DaspletosaurusEntity.attributes().build());
        event.put(ModEntityTypes.DILOPHOSAURUS.get(), DilophosaurusEntity.attributes().build());
        event.put(ModEntityTypes.CERATOSAURUS.get(), CeratosaurusEntity.attributes().build());
